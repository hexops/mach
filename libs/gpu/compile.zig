...
const glfw = @import("zig-deps/mach-glfw/build.zig");
const gpu_dawn_sdk = @import("zig-deps/mach-gpu-dawn/sdk.zig");
const gpu_sdk = @import("sdk.zig");
const system_sdk = @import("zig-deps/mach-glfw/system_sdk.zig");
...
pub fn build(b: *std.build.Builder) !void {
    ...
    const gpu_dawn = gpu_dawn_sdk.Sdk(.{
        .glfw = glfw,
        .glfw_include_dir = "zig-deps/mach-glfw/upstream/glfw/include",
