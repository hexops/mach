//! This example is almost identical to the fragment-shader example,
//! The only difference is in the use of the fragment shader

// TODO add zoom (and julia set?)
...
fn frame(app: *App, params: *FrameParams) !void {
...

    {
        ...
        const proj = zm.perspectiveFovRh(
            (std.math.pi / 7.0), //(std.math.sin(time) * 7 + 9)),
