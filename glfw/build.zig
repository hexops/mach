...
pub fn linkStaticLibrary(b: *Builder, other_lib: *std.build.LibExeObjStep, options: Options) void {
    ...
    other_lib.linkLibrary(engine_lib);
    linkGLFW(b, other_lib, options);
}

/// Link a step with glfw i.e a exe install step
pub fn linkStep(b: *Builder, step: *std.build.LibExeObjStep, options: Options) void {
