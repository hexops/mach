...
const glfw = @import("libs/glfw/compile.zig");
const ecs = @import("libs/ecs/build.zig");
const freetype = @import("libs/freetype/compile.zig");
const basisu = @import("libs/basisu/compile.zig");
...
pub fn build(b: *Builder) !void {
    ...
    if (target.getCpuArch() != .wasm32) {
        ...
        const mach_test_step = b.step("test-mach", "Run Mach library tests");
...
const Packages = struct {
    ...
    const zmath = Pkg{
        .name = "zmath",
        .source = .{ .path = "zig-deps/zmath/src/zmath.zig" },
    };
    const zigimg = Pkg{
        .name = "zigimg",
...
pub const App = struct {
    ...
    pub fn install(app: *const App) void {
        ...
        // TODO: resource installation should be individual files
        // // Install resources
